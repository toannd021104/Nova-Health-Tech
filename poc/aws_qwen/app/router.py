...
Runs on Amazon Nova Micro in Singapore (apac.amazon.nova-micro-v1:0).
Same model and region as aws_claude version — cheapest option, handles
structured JSON output well, ~30x cheaper than Nova Pro on input tokens.
"""
...
- `secondary` is a list (possibly empty) of departments that must be consulted as a side-channel.
...
class RouterDecision:
    ...
    def from_llm_output(cls, raw: str) -> "RouterDecision":
        ...
        dept = obj.get("department", "pulmonology")
