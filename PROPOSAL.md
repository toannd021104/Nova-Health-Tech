# Nova Health Tech Proposal Package

*Companion document to the Terraform infrastructure in this repo.*

Proposal package for Nova Health Tech's clinical decision-support GenAI assistant, covering both **AWS (primary build, backed by the Terraform in /terraform)** and **Alibaba Cloud (proposed)** architectures.
